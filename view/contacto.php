...
<section class="contacto d-flex flex-row justify-content-between gap-5">
  <div class="d-flex flex-column justify-content-between h-100 w-50">
    <div class="cuadro-metodo-cont d-flex flex-column rounded-4 justify-content-between shadow h-auto w-100 bg-white">
      <h3>Contáctanos</h3>
  ...
  <div class="d-flex flex-column justify-content-between h-100 w-50">
    ...
    <div class="cuadro-ubicacion d-flex flex-column justify-content-between rounded-4 shadow w-100 bg-white gap-3">
      <h3>Ubicación</h3>
      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d3599.5321803749425!2d-5.872816323358812!3d43.360769871294615!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1ses!2ses!4v1763723724685!5m2!1ses!2ses" width="100%" height="100%" style="border:0; border-radius: 16px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
  </div>
</section>
